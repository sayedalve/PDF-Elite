...
@given("the pdf has a pdf-elite QR code split marker on page {page_num:d}")
def step_pdf_has_qr_split_marker(context, page_num):
    """Replace page page_num (1-indexed) with a page containing a pdf-elite QR code."""
    try:
    ...
    qr.add_data("https://github.com/PDFElite-Tools/pdf-elite")
    qr.make(fit=True)
