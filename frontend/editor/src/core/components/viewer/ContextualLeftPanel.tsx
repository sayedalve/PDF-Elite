...
export const CONTEXTUAL_RAIL_WIDTH_REM = 3;
...
export function ContextualLeftPanel({
  ...
  return (
    <>
      {/* Contextual Rail — fixed on right side */}
      <Box
        style={{
          position: "absolute",
          left: 0,
          top: 0,
          bottom: 0,
          width: `${CONTEXTUAL_RAIL_WIDTH_REM}rem`,
          backgroundColor: "var(--c-surface-chrome, var(--c-bg-raised))",
